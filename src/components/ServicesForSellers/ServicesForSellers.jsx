...
import styles from './ServicesForSellers.module.scss';
        ...
        <div className={styles.ServicesForSellers}>
            ...
            <div className={styles.How_we_are_working}>
                <div className='container'>
                    <p className={styles.tytle}>Как мы работаем с продавцами</p>
                    ...
                    <div className={styles.blok_card}>
                        ...
                        <span className={[styles.spar, styles.s1].join(' ')}>
                            <img src={spar} alt="" />
                        </span>
                        ...
                        <div className={styles.card}>
                            ...
                            <p className={styles.discr}>Встреча</p>
                        </div>
                        ...
                        <div className={styles.card}>
                            ...
                            <p className={styles.discr}>Покупатель</p>
                        </div>
                        <span className={styles.spar}>
                            <img src={spar} alt="" />
                        </span>
                        ...
                        <div className={styles.card}>
                            ...
                            <p className={styles.discr}>Довольный продавец с деньгами</p>
                        </div>
                        <span className={styles.spar}>
                            <img src={spar} alt="" />
                        </span>
            ...
            <div className={styles.service_block}>
                <div className='container'>
                  <p className={styles.tytle}>Услуги для продавцов</p>
            ...
            <CTA img={bg}
                title='Заявка на продажу объекта'
...
export default ServicesForSellers;
